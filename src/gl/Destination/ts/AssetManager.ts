...
export class AssetManager {
	...
	private load() {
		...
		loader.load( basePath + 'scene/where-is-gone.glb', ( gltf ) => {
		...
		let mustTexPath: TextureInfo[] = [
			// { path: basePath + '/img/blueBoard.png', name: 'BlueBoard' },
			// { path: basePath + '/img/blurBoardDisplay_no_grow.png', name: 'BlueBoardDisplay' },
			// { path: basePath + '/img/tokyo_tower.png', name: 'tokyotower' },
			// { path: basePath + '/img/tape.png', name: 'tape' },
			// { path: basePath + '/img/building.png', name: 'building' },
		];
