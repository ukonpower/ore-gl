...
export class PostProcessing {
	...
	protected depthTexture: THREE.DepthTexture;
	...
	constructor( renderer: THREE.WebGLRenderer, parentUniforms: ORE.Uniforms, textureResolutionRatio?: number, customResolution?: THREE.Vector2 ) {
		...
		this.textureResolutionRatio = 0.4;
	...
	protected init() {
		...
		this.depthTexture = new THREE.DepthTexture( this.sceneRenderTarget.width, this.sceneRenderTarget.height );
		this.sceneRenderTarget.depthTexture = this.depthTexture;
		this.commonUniforms.depthTexture.value = this.depthTexture;
