var $jscomp = $jscomp || {}; $jscomp.scope = {}; $jscomp.ASSUME_ES5 = ! 1; $jscomp.ASSUME_NO_NATIVE_MAP = ! 1; $jscomp.ASSUME_NO_NATIVE_SET = ! 1; $jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function ( d, f, n ) {
...
$jscomp.polyfill = function ( d, f, n, w ) {
	...
	if ( f ) {
		...
		n = $jscomp.global; d = d.split( "." ); for ( w = 0; w < d.length - 1; w ++ ) {

			var g = d[ w ]; g in n || ( n[ g ] = {} ); n = n[ g ];

		}d = d[ d.length - 1 ]; w = n[ d ]; f = f( w ); f != w && null != f && $jscomp.defineProperty( n, d, { configurable: ! 0, writable: ! 0, value: f } );
	...
	return d ? d : function ( f, d ) {
		...
		f = Number( f ); d = Number( d ); var n = f & 65535, g = d & 65535; return n * g + ( ( f >>> 16 & 65535 ) * g + n * ( d >>> 16 & 65535 ) << 16 >>> 0 ) | 0;
...
$jscomp.polyfill( "Math.clz32", function ( d ) {
	...
	return d ? d : function ( f ) {
		...
		f = Number( f ) >>> 0; if ( 0 === f ) return 32; var d = 0; 0 === ( f & 4294901760 ) && ( f <<= 16, d += 16 ); 0 === ( f & 4278190080 ) && ( f <<= 8, d += 8 ); 0 === ( f & 4026531840 ) && ( f <<= 4, d += 4 ); 0 === ( f & 3221225472 ) && ( f <<= 2, d += 2 ); 0 === ( f & 2147483648 ) && d ++; return d;

	};

}, "es6", "es3" ); $jscomp.polyfill( "Math.trunc", function ( d ) {

	return d ? d : function ( d ) {

		d = Number( d ); if ( isNaN( d ) || Infinity === d || - Infinity === d || 0 === d ) return d; var f = Math.floor( Math.abs( d ) ); return 0 > d ? - f : f;
...
}; $jscomp.symbolCounter_ = 0; $jscomp.Symbol = function ( d ) {
...
$jscomp.initSymbolIterator = function () {
	...
	$jscomp.initSymbol(); var d = $jscomp.global.Symbol.iterator; d || ( d = $jscomp.global.Symbol.iterator = $jscomp.global.Symbol( "iterator" ) ); "function" != typeof Array.prototype[ d ] && $jscomp.defineProperty( Array.prototype, d, { configurable: ! 0, writable: ! 0, value: function () {
	...
	var f = 0; return $jscomp.iteratorPrototype( function () {
...
$jscomp.iteratorPrototype = function ( d ) {
	...
	$jscomp.initSymbolIterator(); d = { next: d }; d[ $jscomp.global.Symbol.iterator ] = function () {
	...
	$jscomp.initSymbolIterator(); var f = d[ Symbol.iterator ]; return f ? f.call( d ) : $jscomp.arrayIterator( d );
...
$jscomp.polyfill( "Promise", function ( d ) {
	...
	function f() {
	...
	} if ( d && ! $jscomp.FORCE_POLYFILL_PROMISE ) return d; f.prototype.asyncExecute = function ( d ) {
		...
		var d = this; this.asyncExecuteFunction( function () {

			d.executeBatch_();

		} );

	}; var w = $jscomp.global.setTimeout; f.prototype.asyncExecuteFunction = function ( d ) {
		...
		for ( ;this.batch_ && this.batch_.length; ) {
			...
			var d = this.batch_; this.batch_ = []; for ( var f = 0; f < d.length; ++ f ) {

				var g = d[ f ]; delete d[ f ]; try {
		...
		this.state_ = 0; this.result_ = void 0; this.onSettledCallbacks_ = []; var f = this.createResolveAndReject_(); try {
...
function () {
	...
	function d( d ) {
	...
	} var f = this, g = ! 1; return { resolve: d( this.resolveTo_ ), reject: d( this.reject_ ) };
		...
		if ( d === this ) this.reject_( new TypeError( "A Promise cannot resolve to itself" ) ); else if ( d instanceof g ) this.settleSameAsPromise_( d ); else {
			...
			a:switch ( typeof d ) {
				...
				case "object":var f = null != d; break a; case "function":f = ! 0; break a; default:f = ! 1;
...
void 0; try {
		...
		if ( 0 != this.state_ ) throw Error( "Cannot settle(" + d + ", " + f | "): Promise already settled in state" + this.state_ ); this.state_ = d; this.result_ = f; this.executeOnSettledCallbacks_();
...
this.onSettledCallbacks_, f = 0; f < d.length; ++ f )d[ f ].call(), d[ f ] = null; this.onSettledCallbacks_ = null;
	...
	}; var ma = new f(); g.prototype.settleSameAsPromise_ = function ( d ) {

		var f = this.createResolveAndReject_(); d.callWhenSettled_( f.resolve, f.reject );

	}; g.prototype.settleSameAsThenable_ = function ( d, f ) {

		var g = this.createResolveAndReject_(); try {
		...
		function u( d, f ) {
			...
			} ); this.callWhenSettled_( u( d, n ), u( f, D ) ); return w;
		...
		function g() {
			...
			switch ( n.state_ ) {
				...
				case 1:d( n.result_ ); break; case 2:f( n.result_ ); break; default:throw Error( "Unexpected state: " + n.state_ );

			}

		} var n = this; null == this.onSettledCallbacks_ ? ma.asyncExecute( g ) : this.onSettledCallbacks_.push( function () {

			ma.asyncExecute( g );

		} );

	}; g.resolve = n; g.reject = function ( d ) {
	...
	g.race = function ( d ) {
		...
		var f = $jscomp.makeIterator( d ), u = f.next(); return u.done ? n( [] ) : new g( function ( d, g ) {
			...
			} var D = [], Q = 0; do D.push( void 0 ), Q ++, n( u.value ).callWhenSettled_( w( D.length - 1 ), g ), u = f.next(); while ( ! u.done );
...
var DracoDecoderModule = function ( d ) {
	...
	function f( a, b ) {
		...
		if ( 0 === b || ! e ) return ""; for ( var c = 0, l, d = 0; ; ) {

			l = T[ e + d >> 0 ]; c |= l; if ( 0 == l && ! b ) break; d ++; if ( b && d == b ) break;

		}b || ( b = d ); l = ""; if ( 128 > c ) {

			for ( ;0 < b; )c = String.fromCharCode.apply( String, T.subarray( e, e + Math.min( b, 1024 ) ) ), l = l ? l + c : c, e += 1024, b -= 1024; return l;
		...
		a: {
			...
			var e = Error(); if ( ! e.stack ) {
				...
				try {
					...
					e = "(no stack trace available)"; break a;

				}

			}e = e.stack.toString();

		}a.extraStackTrace && ( e += "\n" + a.extraStackTrace() ); return w( e );

	} function ma( a, b ) {

		0 < a % b && ( a += b - a % b ); return a;

	} function D() {

		a.HEAP8 = fa = new Int8Array( F ); a.HEAP16 = za = new Int16Array( F ); a.HEAP32 = x = new Int32Array( F ); a.HEAPU8 = T = new Uint8Array( F ); a.HEAPU16 = Oa = new Uint16Array( F ); a.HEAPU32 = Pa = new Uint32Array( F ); a.HEAPF32 = Qa = new Float32Array( F ); a.HEAPF64 = Ra = new Float64Array( F );

	} function Ma() {

		var e = a.usingWasm ? Aa : Sa, b = 2147483648 -
e; if ( x[ ba >> 2 ] > b ) return ! 1; var c = y; for ( y = Math.max( y, ib ); y < x[ ba >> 2 ]; )y = 536870912 >= y ? ma( 2 * y, e ) : Math.min( ma( ( 3 * y + 2147483648 ) / 4, e ), b ); e = a.reallocBuffer( y ); if ( ! e || e.byteLength != y ) return y = c, ! 1; a.buffer = F = e; D(); return ! 0;

	} function u( e ) {

		for ( ;0 < e.length; ) {

			var b = e.shift(); if ( "function" == typeof b )b(); else {

				var c = b.func; "number" === typeof c ? void 0 === b.arg ? a.dynCall_v( c ) : a.dynCall_vi( c, b.arg ) : c( void 0 === b.arg ? null : b.arg );
		...
		ha ++; a.monitorRunDependencies && a.monitorRunDependencies( ha );

	} function Na( e ) {

		ha --;
		a.monitorRunDependencies && a.monitorRunDependencies( ha ); 0 == ha && ( null !== Ba && ( clearInterval( Ba ), Ba = null ), sa && ( e = sa, sa = null, e() ) );
		...
		var e = A.last; if ( ! e ) return ( m.setTempRet0( 0 ), 0 ) | 0; var b = A.infos[ e ], c = b.type; if ( ! c ) return ( m.setTempRet0( 0 ), e ) | 0; var l = Array.prototype.slice.call( arguments ); a.___cxa_is_pointer_type( c ); qa.buffer || ( qa.buffer = Ta( 4 ) ); x[ qa.buffer >> 2 ] = e; e = qa.buffer; for ( var d = 0; d < l.length; d ++ ) if ( l[ d ] && a.___cxa_can_catch( l[ d ], c, e ) ) return e = x[ e >>
2 ], b.adjusted = e, ( m.setTempRet0( l[ d ] ), e ) | 0; e = x[ e >> 2 ]; return ( m.setTempRet0( c ), e ) | 0;

	} function Q( e, b ) {

		v.varargs = b; try {

			var c = v.get(), l = v.get(), d = v.get(); e = 0; Q.buffer || ( Q.buffers = [ null, [], []], Q.printChar = function ( b, c ) {

				var e = Q.buffers[ b ]; f( e ); if ( 0 === c || 10 === c ) {

					b = 1 === b ? a.print : a.printErr; a: {

						for ( var l = c = 0; e[ l ]; )++ l; if ( 16 < l - c && e.subarray && Ua )c = Ua.decode( e.subarray( c, l ) ); else for ( l = ""; ; ) {
							...
							var d = e[ c ++ ]; if ( ! d ) {
								...
								var g = e[ c ++ ] & 63; if ( 192 == ( d & 224 ) )l += String.fromCharCode( ( d & 31 ) << 6 | g ); else {

									var h = e[ c ++ ] &
63; if ( 224 == ( d & 240 ) )d = ( d & 15 ) << 12 | g << 6 | h; else {

										var E = e[ c ++ ] & 63; if ( 240 == ( d & 248 ) )d = ( d & 7 ) << 18 | g << 12 | h << 6 | E; else {

											var k = e[ c ++ ] & 63; if ( 248 == ( d & 252 ) )d = ( d & 3 ) << 24 | g << 18 | h << 12 | E << 6 | k; else {

												var ta = e[ c ++ ] & 63; d = ( d & 1 ) << 30 | g << 24 | h << 18 | E << 12 | k << 6 | ta;
				...
				for ( var h = x[ l + 8 * b >> 2 ], g = x[ l + ( 8 * b + 4 ) >> 2 ], k = 0; k < g; k ++ )Q.printChar( c, T[ h + k ] ); e += g;
...
typeof FS && Ca instanceof FS.ErrnoError || W( Ca ), - Ca.errno;
		...
		ra.seen || ( ra.seen = {} ); e in ra.seen || ( a.dynCall_v( b ), ra.seen[ e ] = 1 );
		...
		function b() {
			...
			if ( ! a.calledRun && ( a.calledRun = ! 0, ! ua ) ) {
				...
				Va || ( Va = ! 0, u( Wa ) ); u( Xa ); if ( a.onRuntimeInitialized )a.onRuntimeInitialized(); if ( a.postRun ) for ( "function" == typeof a.postRun && ( a.postRun = [ a.postRun ] ); a.postRun.length; )Ya.unshift( a.postRun.shift() );
				u( Ya );

			}

		}null === Za && ( Za = Date.now() ); if ( ! ( 0 < ha ) ) {

			if ( a.preRun ) for ( "function" == typeof a.preRun && ( a.preRun = [ a.preRun ] ); a.preRun.length; )$a.unshift( a.preRun.shift() ); u( $a ); 0 < ha || a.calledRun || ( a.setStatus ? ( a.setStatus( "Running..." ), setTimeout( function () {
		...
		if ( a.onAbort )a.onAbort( e ); void 0 !== e ? ( a.print( e ), a.printErr( e ), e = JSON.stringify( e ) ) : e = ""; ua = ! 0; var b = "abort(" + e + ") at " + g() + "\nIf this abort() is unexpected, build with -s ASSERTIONS=1 which can give more information.";
	...
	} function p() {} function t( a ) {

		return ( a || p ).__cache__;

	} function X( a, b ) {

		var c = t( b ), e = c[ a ]; if ( e ) return e; e = Object.create( ( b || p ).prototype ); e.ptr = a; return c[ a ] = e;
		...
		if ( "string" === typeof a ) {
			...
			for ( var b = 0, c = 0; c < a.length; ++ c ) {
				...
				var e = a.charCodeAt( c ); 55296 <= e && 57343 >= e && ( e = 65536 + ( ( e & 1023 ) << 10 ) | a.charCodeAt( ++ c ) & 1023 ); 127 >= e ? ++ b : b = 2047 >= e ? b + 2 : 65535 >= e ? b + 3 : 2097151 >= e ? b + 4 : 67108863 >= e ? b + 5 : b + 6;

			}b = Array( b + 1 ); c = 0; e = b.length; if ( 0 < e ) {

				e = c + e - 1; for ( var d = 0; d < a.length; ++ d ) {

					var f =
a.charCodeAt( d ); 55296 <= f && 57343 >= f && ( f = 65536 + ( ( f & 1023 ) << 10 ) | a.charCodeAt( ++ d ) & 1023 ); if ( 127 >= f ) {
						...
						if ( 2047 >= f ) {
							...
							if ( c + 1 >= e ) break; b[ c ++ ] = 192 | f >> 6;

						} else {

							if ( 65535 >= f ) {

								if ( c + 2 >= e ) break; b[ c ++ ] = 224 | f >> 12;

							} else {

								if ( 2097151 >= f ) {

									if ( c + 3 >= e ) break; b[ c ++ ] = 240 | f >> 18;

								} else {

									if ( 67108863 >= f ) {

										if ( c + 4 >= e ) break; b[ c ++ ] = 248 | f >> 24;

									} else {

										if ( c + 5 >= e ) break; b[ c ++ ] = 252 | f >> 30; b[ c ++ ] = 128 | f >> 24 & 63;
	...
	function B() {
		...
		this.ptr = lb(); t( G )[ this.ptr ] = this;

	} function H() {

		this.ptr = mb(); t( H )[ this.ptr ] = this;

	} function I() {

		this.ptr = nb(); t( I )[ this.ptr ] = this;

	} function J() {

		this.ptr = ob(); t( J )[ this.ptr ] = this;

	} function K() {

		this.ptr = pb(); t( K )[ this.ptr ] = this;

	} function q() {

		this.ptr = qb(); t( q )[ this.ptr ] = this;

	} function P() {

		this.ptr = rb(); t( P )[ this.ptr ] = this;

	} function z() {

		this.ptr = sb(); t( z )[ this.ptr ] = this;

	} function L() {

		this.ptr = tb(); t( L )[ this.ptr ] = this;

	} function r() {

		this.ptr =
ub(); t( r )[ this.ptr ] = this;

	} function M() {

		this.ptr = vb(); t( M )[ this.ptr ] = this;

	} function N() {

		this.ptr = wb(); t( N )[ this.ptr ] = this;

	} function Z() {

		this.ptr = xb(); t( Z )[ this.ptr ] = this;

	} function R() {

		this.ptr = yb(); t( R )[ this.ptr ] = this;

	} function h() {

		this.ptr = zb(); t( h )[ this.ptr ] = this;

	} function C() {

		this.ptr = Ab(); t( C )[ this.ptr ] = this;
		...
		this.ptr = Bb(); t( O )[ this.ptr ] = this;

	} function S() {

		this.ptr = Cb(); t( S )[ this.ptr ] = this;

	} var a = d = d || {}, bb = ! 1, cb = ! 1; a.onRuntimeInitialized =
function () {

	bb = ! 0; if ( cb && "function" === typeof a.onModuleLoaded )a.onModuleLoaded( a );

}; a.onModuleParsed = function () {

		cb = ! 0; if ( bb && "function" === typeof a.onModuleLoaded )a.onModuleLoaded( a );
	...
	}; a || ( a = ( "undefined" !== typeof d ? d : null ) || {} ); var va = {}, da; for ( da in a )a.hasOwnProperty( da ) && ( va[ da ] = a[ da ] ); var oa = ! 1, ka = ! 1, pa = ! 1, wa = ! 1; if ( a.ENVIRONMENT ) if ( "WEB" ===
a.ENVIRONMENT )oa = ! 0; else if ( "WORKER" === a.ENVIRONMENT )ka = ! 0; else if ( "NODE" === a.ENVIRONMENT )pa = ! 0; else if ( "SHELL" === a.ENVIRONMENT )wa = ! 0; else throw Error( "The provided Module['ENVIRONMENT'] value is not valid. It must be one of: WEB|WORKER|NODE|SHELL." ); else oa = "object" === typeof window, ka = "function" === typeof importScripts, pa = "object" === typeof process && "function" === typeof require && ! oa && ! ka, wa = ! oa && ! pa && ! ka; if ( pa ) {

		a.print || ( a.print = console.log ); a.printErr || ( a.printErr = console.warn ); var Ea, Fa; a.read = function ( a,
			b ) {

			Ea || ( Ea = require( "fs" ) ); Fa || ( Fa = require( "path" ) ); a = Fa.normalize( a ); a = Ea.readFileSync( a ); return b ? a : a.toString();

		}; a.readBinary = function ( e ) {

			e = a.read( e, ! 0 ); e.buffer || ( e = new Uint8Array( e ) ); f( e.buffer ); return e;

		}; a.thisProgram || ( a.thisProgram = 1 < process.argv.length ? process.argv[ 1 ].replace( /\\/g, "/" ) : "unknown-program" ); a.arguments = process.argv.slice( 2 ); process.on( "uncaughtException", function ( a ) {
...
( a.print = print ), "undefined" != typeof printErr && ( a.printErr = printErr ), a.read = "undefined" != typeof read ? function ( a ) {
		...
		if ( "function" === typeof readbuffer ) return new Uint8Array( readbuffer( a ) ); a = read( a, "binary" ); f( "object" === typeof a ); return a;
...
function ( a ) {
	...
	} ); else throw Error( "Unknown runtime environment. Where are we?" ); a.print || ( a.print = function () {} ); a.printErr || ( a.printErr = a.print ); a.arguments || ( a.arguments = [] ); a.thisProgram || ( a.thisProgram = "./this.program" ); a.quit || ( a.quit = function ( a, b ) {

		throw b;

	} ); a.print =
a.print; a.printErr = a.printErr; a.preRun = []; a.postRun = []; for ( da in va )va.hasOwnProperty( da ) && ( a[ da ] = va[ da ] ); va = void 0; var m = { setTempRet0: function ( a ) {
			...
			switch ( a ) {
				...
				case "i1":case "i8":return 1; case "i16":return 2; case "i32":return 4; case "i64":return 8; case "float":return 4; case "double":return 8; default:return "*" === a[ a.length - 1 ] ? m.QUANTUM_SIZE : "i" === a[ 0 ] ?
			...
			"double" === b || "i64" === b ? a & 7 && ( f( 4 === ( a & 7 ) ), a += 4 ) : f( 0 === ( a & 3 ) ); return a;
		...
		addFunction: function ( a ) {
			...
			for ( var b = 0; b < m.functionPointers.length; b ++ ) if ( ! m.functionPointers[ b ] ) return m.functionPointers[ b ] = a, 2 * ( 1 + b ); throw "Finished up all reserved function pointers. Use a higher value for RESERVED_FUNCTION_POINTERS.";
			...
			m.warnOnce.shown || ( m.warnOnce.shown = {} ); m.warnOnce.shown[ e ] || ( m.warnOnce.shown[ e ] = 1, a.printErr( e ) );

		}, funcWrappers: {}, getFuncWrapper: function ( a, b ) {

			if ( a ) {

				f( b ); m.funcWrappers[ b ] || ( m.funcWrappers[ b ] =
{} ); var c = m.funcWrappers[ b ]; c[ a ] || ( c[ a ] = 1 === b.length ? function () {
			...
			var b = U; U = U + a | 0; U = U + 15 & - 16; return b;

		}, staticAlloc: function ( a ) {

			var b = aa; aa = aa + a | 0; aa = aa + 15 &
- 16; return b;

		}, dynamicAlloc: function ( a ) {

			var b = x[ ba >> 2 ]; a = ( b + a + 15 | 0 ) & - 16; x[ ba >> 2 ] = a; return a >= y && ! Ma() ? ( x[ ba >> 2 ] = b, 0 ) : b;
		...
		}, GLOBAL_BASE: 1024, QUANTUM_SIZE: 4, __dummy__: 0 }, ua = 0, Ua = "undefined" !== typeof TextDecoder ? new TextDecoder( "utf8" ) : void 0; "undefined" !== typeof TextDecoder && new TextDecoder( "utf-16le" ); var Aa = 65536, Sa = 16777216, ib = 16777216, fa, T, za,
		Oa, x, Pa, Qa, Ra, aa, Ga, U, xa, Ha, ba; var Ia = aa = Ga = U = xa = Ha = ba = 0; a.reallocBuffer || ( a.reallocBuffer = function ( a ) {

		try {

			if ( ArrayBuffer.transfer ) var b = ArrayBuffer.transfer( F, a ); else {

				var c = fa; b = new ArrayBuffer( a ); ( new Int8Array( b ) ).set( c );
		...
		var Ja = Function.prototype.call.bind( Object.getOwnPropertyDescriptor( ArrayBuffer.prototype, "byteLength" ).get ); Ja( new ArrayBuffer( 4 ) );
	...
	a.HEAPU32 = Pa; a.HEAPF32 = Qa; a.HEAPF64 = Ra; var $a = [], Wa = [], Xa = [], db = [], Ya = [], Va = ! 1; f( Math.imul && Math.fround && Math.clz32 && Math.trunc, "this is a legacy browser, build with LEGACY_VM_SUPPORT" ); var ha = 0, Ba = null, sa = null; a.preloadedImages = {}; a.preloadedAudios = {}; var V = null; ( function () {

		function e() {

			try {

				if ( a.wasmBinary ) return new Uint8Array( a.wasmBinary ); if ( a.readBinary ) return a.readBinary( d ); throw "on the web, we need the wasm binary to be preloaded and set on Module['wasmBinary']. emcc.py will do that for you when generating HTML (but not JS)";
			...
			return a.wasmBinary || ! oa && ! ka || "function" !== typeof fetch ? new Promise( function ( a, b ) {
				...
				if ( ! a.ok ) throw "failed to load wasm binary file at '" + d + "'"; return a.arrayBuffer();
			...
			function f( b, c ) {
				...
				h = b.exports; if ( h.memory ) {

					b = h.memory; c = a.buffer; b.byteLength < c.byteLength && a.printErr( "the new buffer in mergeMemory is smaller than the previous one. in native wasm, we should grow memory here" );
					c = new Int8Array( c ); var e = new Int8Array( b ); V || c.set( e.subarray( a.STATIC_BASE, a.STATIC_BASE + a.STATIC_BUMP ), a.STATIC_BASE ); e.set( c ); a.buffer = F = b; D();

				}a.asm = h; a.usingWasm = ! 0; Na( "wasm-instantiate" );
				...
				b().then( function ( a ) {
					...
					a.printErr( "failed to asynchronously prepare wasm: " + b ); W( b );

				} );

			} if ( "object" !== typeof WebAssembly ) return a.printErr( "no native wasm support detected" ), ! 1; if ( ! ( a.wasmMemory instanceof
WebAssembly.Memory ) ) return a.printErr( "no native wasm Memory in use" ), ! 1; e.memory = a.wasmMemory; g.global = { NaN: NaN, Infinity: Infinity }; g[ "global.Math" ] = c.Math; g.env = e; la( "wasm-instantiate" ); if ( a.instantiateWasm ) try {
				...
				a.printErr( "wasm streaming compile failed: " + b ); a.printErr( "falling back to ArrayBuffer instantiation" ); k( E );

			} ); return {};

		} var d = "draco_decoder.wasm", f = "draco_decoder.temp.asm.js"; "function" === typeof a.locateFile && ( a.locateFile( "draco_decoder.wast" ), d = a.locateFile( d ), f = a.locateFile( f ) ); var g = { global: null, env: null, asm2wasm: { "f64-rem": function ( a, b ) {
			...
			} }, parent: a }, h = null; a.asmPreload = a.asm; var k = a.reallocBuffer; a.reallocBuffer = function ( b ) {

			if ( "asmjs" ===
m ) var c = k( b ); else a: {

				b = ma( b, a.usingWasm ? Aa : Sa ); var e = a.buffer.byteLength; if ( a.usingWasm ) try {

					c = - 1 !== a.wasmMemory.grow( ( b - e ) / 65536 ) ? a.buffer = a.wasmMemory.buffer : null; break a;
		...
		}; var m = ""; a.asm = function ( b, e, d ) {

			if ( ! e.table ) {

				var l = a.wasmTableSize; void 0 === l && ( l = 1024 ); var f = a.wasmMaxTableSize; e.table = "object" === typeof WebAssembly && "function" === typeof WebAssembly.Table ? void 0 !== f ? new WebAssembly.Table( { initial: l, maximum: f, element: "anyfunc" } ) : new WebAssembly.Table( { initial: l,
					element: "anyfunc" } ) : Array( l ); a.wasmTable = e.table;

			}e.memoryBase || ( e.memoryBase = a.STATIC_BASE ); e.tableBase || ( e.tableBase = 0 ); ( b = c( b, e, d ) ) || W( "no binaryen method succeeded. consider enabling more options, like interpreting, if you want that: https://github.com/kripken/emscripten/wiki/WebAssembly#binaryen-methods" ); return b;

		};

	} )(); Ia = m.GLOBAL_BASE; aa = Ia + 19104; Wa.push(); V = null; a.STATIC_BASE = Ia; a.STATIC_BUMP = 19104; var Eb = aa; aa += 16; var A = { last: 0, caught: [], infos: {}, deAdjust: function ( a ) {

			if ( ! a || A.infos[ a ] ) return a;
			for ( var b in A.infos ) if ( A.infos[ b ].adjusted === a ) return b; return a;
			...
			if ( e ) {
				...
				var b = A.infos[ e ]; f( 0 < b.refcount ); b.refcount --; 0 !== b.refcount || b.rethrown || ( b.destructor && a.dynCall_vi( b.destructor, e ), delete A.infos[ e ], ___cxa_free_exception( e ) );
		...
		} }, v = { varargs: 0, get: function ( a ) {

			v.varargs += 4; return x[ v.varargs - 4 >> 2 ];
			...
			var a = v.get(), b = v.get(); 0 <= a ?
				f( 0 === b ) : f( - 1 === b ); return a;

		}, getZero: function () {

			f( 0 === v.get() );

		} }, ya = {}, La = 1; db.push( function () {

		var e = a._fflush; e && e( 0 ); if ( e = Q.printChar ) {

			var b = Q.buffers; b[ 1 ].length && e( 1, 10 ); b[ 2 ].length && e( 2, 10 );

		}

	} ); ba = m.staticAlloc( 4 ); Ga = U = m.alignMemory( aa ); xa = Ga + Ka; Ha = m.alignMemory( xa ); x[ ba >> 2 ] = Ha; a.wasmTableSize = 492; a.wasmMaxTableSize = 492; a.asmGlobalArg = { Math: Math, Int8Array: Int8Array, Int16Array: Int16Array, Int32Array: Int32Array, Uint8Array: Uint8Array, Uint16Array: Uint16Array, Uint32Array: Uint32Array, Float32Array: Float32Array,
	...
	invoke_ii: function ( e, b ) {
		...
		try {
			...
			if ( "number" !== typeof l && "longjmp" !== l ) throw l; a.setThrew( 1, 0 );
		...
		try {
			...
			if ( "number" !== typeof E && "longjmp" !== E ) throw E; a.setThrew( 1, 0 );
		...
		try {
			...
			if ( "number" !==
typeof ja && "longjmp" !== ja ) throw ja; a.setThrew( 1, 0 );
		...
		try {
			...
			if ( "number" !== typeof b && "longjmp" !== b ) throw b; a.setThrew( 1, 0 );
		...
		try {
			...
			if ( "number" !== typeof E &&
"longjmp" !== E ) throw E; a.setThrew( 1, 0 );
		...
		try {
			...
			if ( "number" !== typeof ta && "longjmp" !== ta ) throw ta; a.setThrew( 1, 0 );
		...
		try {
			...
			if ( "number" !== typeof ia && "longjmp" !== ia ) throw ia; a.setThrew( 1, 0 );
		...
		try {
			...
			if ( "number" !== typeof ja && "longjmp" !== ja ) throw ja; a.setThrew( 1, 0 );
	...
	___cxa_allocate_exception: function ( a ) {
		...
		var b = A.infos[ a ]; b && ! b.caught && ( b.caught = ! 0, na.uncaught_exception -- ); b && ( b.rethrown = ! 1 ); A.caught.push( a ); A.addRef( A.deAdjust( a ) ); return a;

	}, ___cxa_find_matching_catch: qa, ___cxa_pure_virtual: function () {

		ua = ! 0; throw "Pure virtual function called!";

	}, ___cxa_throw: function ( a, b, c ) {

		A.infos[ a ] = { ptr: a, adjusted: a, type: b, destructor: c, refcount: 0, caught: ! 1, rethrown: ! 1 }; A.last = a; "uncaught_exception" in na ? na.uncaught_exception ++ : na.uncaught_exception =
1; throw a + " - Exception catching is disabled, this exception cannot be caught. Compile with -s DISABLE_EXCEPTION_CATCHING=0 or DISABLE_EXCEPTION_CATCHING=2 to catch.";

	}, ___gxx_personality_v0: function () {}, ___resumeException: function ( a ) {

		A.last || ( A.last = a ); throw a + " - Exception catching is disabled, this exception cannot be caught. Compile with -s DISABLE_EXCEPTION_CATCHING=0 or DISABLE_EXCEPTION_CATCHING=2 to catch.";

	}, ___setErrNo: function ( e ) {

		a.___errno_location && ( x[ a.___errno_location() >> 2 ] = e ); return e;
	...
	___syscall140: function ( a, b ) {
		...
		v.varargs = b; try {
			...
			var c = v.getStreamFromFD(); v.get(); var e = v.get(), d = v.get(), f = v.get(); FS.llseek( c, e, f ); x[ d >> 2 ] = c.position; c.getdents && 0 === e && 0 === f && ( c.getdents = null ); return 0;
		...
		v.varargs = b; return 0;

	}, ___syscall6: function ( a, b ) {

		v.varargs = b; try {

			var c = v.getStreamFromFD(); FS.close( c ); return 0;
...
W( l ), - l.errno;
		...
		T.set( T.subarray( b, b + c ), a ); return a;
		...
		if ( 0 == a ) return 22; x[ a >> 2 ] = La; ya[ La ] = 0; La ++; return 0;

	}, _pthread_once: ra, _pthread_setspecific: function ( a, b ) {

		if ( ! ( a in ya ) ) return 22; ya[ a ] = b; return 0;

	}, DYNAMICTOP_PTR: ba, tempDoublePtr: Eb, ABORT: ua, STACKTOP: U, STACK_MAX: xa }; var eb = a.asm( a.asmGlobalArg, a.asmLibraryArg, F ); a.asm = eb; a.___cxa_can_catch = function () {
...
function () {
	...
	a.dynCall_iiiiiii = function () {
	...
	}; m.stackAlloc = a.stackAlloc; m.stackSave = a.stackSave; m.stackRestore = a.stackRestore; m.establishStackSpace = a.establishStackSpace; m.setTempRet0 = a.setTempRet0; m.getTempRet0 = a.getTempRet0; a.asm = eb; if ( V ) if ( "function" === typeof a.locateFile ? V = a.locateFile( V ) : a.memoryInitializerPrefixURL && ( V = a.memoryInitializerPrefixURL + V ), pa || wa ) {

		var Id = a.readBinary( V ); T.set( Id, m.GLOBAL_BASE );
		...
		}; la( "memory initializer" ); var fb = function ( d ) {

			d.byteLength && ( d = new Uint8Array( d ) ); T.set( d, m.GLOBAL_BASE ); a.memoryInitializerRequest && delete a.memoryInitializerRequest.response; Na( "memory initializer" );

		}; if ( a.memoryInitializerRequest ) {

			var hb = function () {

				var d = a.memoryInitializerRequest, b = d.response; 200 !== d.status && 0 !== d.status ? ( console.warn( "a problem seems to have happened with Module.memoryInitializerRequest, status: " + d.status + ", retrying " +
V ), gb() ) : fb( b );
		...
		if ( a.calledRun )d( a ); else {
			...
			var b = a.onRuntimeInitialized; a.onRuntimeInitialized = function () {
	...
	}; ea.prototype = Error(); ea.prototype.constructor = ea; var Za = null; sa = function b() {

		a.calledRun || Da(); a.calledRun || ( sa = b );

	}; a.run = Da; a.exit = function ( b, c ) {

		if ( ! c || ! a.noExitRuntime ) {

			if ( ! a.noExitRuntime && ( ua = ! 0, U = void 0, u( db ), a.onExit ) )a.onExit( b ); pa &&
process.exit( b ); a.quit( b, new ea( b ) );

		}

	}; var ab = []; a.abort = W; if ( a.preInit ) for ( "function" == typeof a.preInit && ( a.preInit = [ a.preInit ] ); 0 < a.preInit.length; )a.preInit.pop()(); Da(); p.prototype = Object.create( p.prototype ); p.prototype.constructor = p; p.prototype.__class__ = p; p.__cache__ = {}; a.WrapperObject = p; a.getCache = t; a.wrapPointer = X; a.castObject = function ( a, c ) {

		return X( a.ptr, c );

	}; a.NULL = X( 0 ); a.destroy = function ( a ) {

		if ( ! a.__destroy__ ) throw "Error: Cannot destroy object. (Did you create it yourself?)"; a.__destroy__();
	...
	}; var k = { buffer: 0, size: 0, pos: 0, temps: [], needed: 0, prepare: function () {

		if ( k.needed ) {

			for ( var b = 0; b < k.temps.length; b ++ )a._free( k.temps[ b ] ); k.temps.length = 0; a._free( k.buffer ); k.buffer = 0; k.size += k.needed; k.needed = 0;

		}k.buffer || ( k.size += 128, k.buffer = a._malloc( k.size ), f( k.buffer ) ); k.pos = 0;

	}, alloc: function ( b, c ) {

		f( k.buffer ); b = b.length * c.BYTES_PER_ELEMENT; b =
b + 7 & - 8; k.pos + b >= k.size ? ( f( 0 < b ), k.needed += b, c = a._malloc( b ), k.temps.push( c ) ) : ( c = k.buffer + k.pos, k.pos += b ); return c;
	...
	} }; B.prototype = Object.create( p.prototype ); B.prototype.constructor = B; B.prototype.__class__ = B; B.__cache__ = {}; a.Status = B; B.prototype.code = B.prototype.code = function () {
...
B.prototype.error_msg = function () {
	...
	}; G.prototype = Object.create( p.prototype ); G.prototype.constructor = G; G.prototype.__class__ = G; G.__cache__ = {}; a.DracoUInt16Array = G; G.prototype.GetValue = G.prototype.GetValue = function ( a ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return zc( b, a );
	...
	H.prototype = Object.create( p.prototype ); H.prototype.constructor = H; H.prototype.__class__ = H; H.__cache__ = {}; a.PointCloud = H; H.prototype.num_attributes = H.prototype.num_attributes = function () {
	...
	}; I.prototype = Object.create( p.prototype ); I.prototype.constructor = I; I.prototype.__class__ = I; I.__cache__ = {}; a.DracoUInt8Array = I; I.prototype.GetValue =
I.prototype.GetValue = function ( a ) {

	var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return Fc( b, a );
	...
	}; J.prototype = Object.create( p.prototype ); J.prototype.constructor = J; J.prototype.__class__ = J; J.__cache__ = {}; a.DracoUInt32Array = J; J.prototype.GetValue = J.prototype.GetValue = function ( a ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return Cc( b, a );
...
function () {
	...
	}; K.prototype = Object.create( p.prototype ); K.prototype.constructor = K; K.prototype.__class__ = K; K.__cache__ = {}; a.AttributeOctahedronTransform = K; K.prototype.InitFromAttribute = K.prototype.InitFromAttribute = function ( a ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return !! Fb( b, a );
...
q.prototype.num_components = function () {
	...
	}; P.prototype = Object.create( p.prototype ); P.prototype.constructor =
P; P.prototype.__class__ = P; P.__cache__ = {}; a.AttributeTransformData = P; P.prototype.transform_type = P.prototype.transform_type = function () {
	...
	}; z.prototype = Object.create( p.prototype ); z.prototype.constructor = z; z.prototype.__class__ = z; z.__cache__ = {}; a.AttributeQuantizationTransform = z; z.prototype.InitFromAttribute = z.prototype.InitFromAttribute = function ( a ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return !! Ib( b, a );
	...
	z.prototype.quantization_bits = z.prototype.quantization_bits = function () {
		...
		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return Kb( b, a );
	...
	}; L.prototype = Object.create( p.prototype ); L.prototype.constructor = L; L.prototype.__class__ = L; L.__cache__ = {}; a.DracoInt8Array = L; L.prototype.GetValue = L.prototype.GetValue =
function ( a ) {

	var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return wc( b, a );
	...
	}; r.prototype = Object.create( p.prototype ); r.prototype.constructor = r; r.prototype.__class__ = r; r.__cache__ = {}; a.MetadataQuerier = r; r.prototype.HasEntry = r.prototype.HasEntry = function ( a, c ) {

		var b = this.ptr; k.prepare(); a && "object" === typeof a && ( a = a.ptr ); c = c && "object" === typeof c ? c.ptr : Y( c ); return !! Sc( b,
			a, c );

	}; r.prototype.HasIntEntry = r.prototype.HasIntEntry = function ( a, c ) {

		var b = this.ptr; k.prepare(); a && "object" === typeof a && ( a = a.ptr ); c = c && "object" === typeof c ? c.ptr : Y( c ); return !! Tc( b, a, c );

	}; r.prototype.GetIntEntry = r.prototype.GetIntEntry = function ( a, c ) {

		var b = this.ptr; k.prepare(); a && "object" === typeof a && ( a = a.ptr ); c = c && "object" === typeof c ? c.ptr : Y( c ); return Pc( b, a, c );

	}; r.prototype.HasDoubleEntry = r.prototype.HasDoubleEntry = function ( a, c ) {

		var b = this.ptr; k.prepare(); a && "object" === typeof a && ( a = a.ptr ); c = c && "object" ===
typeof c ? c.ptr : Y( c ); return !! Rc( b, a, c );

	}; r.prototype.GetDoubleEntry = r.prototype.GetDoubleEntry = function ( a, c ) {

		var b = this.ptr; k.prepare(); a && "object" === typeof a && ( a = a.ptr ); c = c && "object" === typeof c ? c.ptr : Y( c ); return Nc( b, a, c );

	}; r.prototype.HasStringEntry = r.prototype.HasStringEntry = function ( a, c ) {

		var b = this.ptr; k.prepare(); a && "object" === typeof a && ( a = a.ptr ); c = c && "object" === typeof c ? c.ptr : Y( c ); return !! Uc( b, a, c );

	}; r.prototype.GetStringEntry = r.prototype.GetStringEntry = function ( a, c ) {

		var b = this.ptr; k.prepare();
		a && "object" === typeof a && ( a = a.ptr ); c = c && "object" === typeof c ? c.ptr : Y( c ); return n( Qc( b, a, c ) );

	}; r.prototype.NumEntries = r.prototype.NumEntries = function ( a ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return Vc( b, a );

	}; r.prototype.GetEntryName = r.prototype.GetEntryName = function ( a, c ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); return n( Oc( b, a, c ) );

	}; r.prototype.__destroy__ = r.prototype.__destroy__ = function () {

		Wc( this.ptr );

	}; M.prototype = Object.create( p.prototype ); M.prototype.constructor =
M; M.prototype.__class__ = M; M.__cache__ = {}; a.DracoInt16Array = M; M.prototype.GetValue = M.prototype.GetValue = function ( a ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return qc( b, a );
	...
	}; N.prototype = Object.create( p.prototype ); N.prototype.constructor = N; N.prototype.__class__ = N; N.__cache__ = {}; a.DracoFloat32Array = N; N.prototype.GetValue = N.prototype.GetValue = function ( a ) {

		var b =
this.ptr; a && "object" === typeof a && ( a = a.ptr ); return nc( b, a );
	...
	}; Z.prototype = Object.create( p.prototype ); Z.prototype.constructor = Z; Z.prototype.__class__ = Z; Z.__cache__ = {}; a.GeometryAttribute = Z; Z.prototype.__destroy__ = Z.prototype.__destroy__ = function () {

		Ic( this.ptr );

	}; R.prototype = Object.create( p.prototype ); R.prototype.constructor = R; R.prototype.__class__ = R; R.__cache__ = {};
	a.DecoderBuffer = R; R.prototype.Init = R.prototype.Init = function ( a, c ) {

		var b = this.ptr; k.prepare(); if ( "object" == typeof a && "object" === typeof a ) {

			var d = k.alloc( a, fa ); k.copy( a, fa, d ); a = d;
	...
	}; h.prototype = Object.create( p.prototype ); h.prototype.constructor = h; h.prototype.__class__ = h; h.__cache__ = {}; a.Decoder = h; h.prototype.GetEncodedGeometryType = h.prototype.GetEncodedGeometryType = function ( a ) {

		var b = this.ptr;
		a && "object" === typeof a && ( a = a.ptr ); return hc( b, a );

	}; h.prototype.DecodeBufferToPointCloud = h.prototype.DecodeBufferToPointCloud = function ( a, c ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); return X( Sb( b, a, c ), B );

	}; h.prototype.DecodeBufferToMesh = h.prototype.DecodeBufferToMesh = function ( a, c ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); return X( Rb( b, a, c ), B );

	}; h.prototype.GetAttributeId = h.prototype.GetAttributeId = function ( a, c ) {

		var b = this.ptr;
		a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); return Yb( b, a, c );

	}; h.prototype.GetAttributeIdByName = h.prototype.GetAttributeIdByName = function ( a, c ) {

		var b = this.ptr; k.prepare(); a && "object" === typeof a && ( a = a.ptr ); c = c && "object" === typeof c ? c.ptr : Y( c ); return Xb( b, a, c );

	}; h.prototype.GetAttributeIdByMetadataEntry = h.prototype.GetAttributeIdByMetadataEntry = function ( a, c, d ) {

		var b = this.ptr; k.prepare(); a && "object" === typeof a && ( a = a.ptr ); c = c && "object" === typeof c ? c.ptr : Y( c ); d = d && "object" === typeof d ?
			d.ptr : Y( d ); return Wb( b, a, c, d );

	}; h.prototype.GetAttribute = h.prototype.GetAttribute = function ( a, c ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); return X( gc( b, a, c ), q );

	}; h.prototype.GetAttributeByUniqueId = h.prototype.GetAttributeByUniqueId = function ( a, c ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); return X( Tb( b, a, c ), q );

	}; h.prototype.GetMetadata = h.prototype.GetMetadata = function ( a ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return X( jc( b,
			a ), S );

	}; h.prototype.GetAttributeMetadata = h.prototype.GetAttributeMetadata = function ( a, c ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); return X( cc( b, a, c ), S );

	}; h.prototype.GetFaceFromMesh = h.prototype.GetFaceFromMesh = function ( a, c, d ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! ic( b, a, c, d );

	}; h.prototype.GetTriangleStripsFromMesh = h.prototype.GetTriangleStripsFromMesh = function ( a, c ) {

		var b = this.ptr;
		a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); return kc( b, a, c );

	}; h.prototype.GetAttributeFloat = h.prototype.GetAttributeFloat = function ( a, c, d ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! Vb( b, a, c, d );

	}; h.prototype.GetAttributeFloatForAllPoints = h.prototype.GetAttributeFloatForAllPoints = function ( a, c, d ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); d && "object" === typeof d &&
( d = d.ptr ); return !! Ub( b, a, c, d );

	}; h.prototype.GetAttributeIntForAllPoints = h.prototype.GetAttributeIntForAllPoints = function ( a, c, d ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! bc( b, a, c, d );

	}; h.prototype.GetAttributeInt8ForAllPoints = h.prototype.GetAttributeInt8ForAllPoints = function ( a, c, d ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! ac( b, a, c, d );

	};
	h.prototype.GetAttributeUInt8ForAllPoints = h.prototype.GetAttributeUInt8ForAllPoints = function ( a, c, d ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! fc( b, a, c, d );

	}; h.prototype.GetAttributeInt16ForAllPoints = h.prototype.GetAttributeInt16ForAllPoints = function ( a, c, d ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! Zb( b, a, c, d );

	}; h.prototype.GetAttributeUInt16ForAllPoints =
h.prototype.GetAttributeUInt16ForAllPoints = function ( a, c, d ) {

	var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! dc( b, a, c, d );

}; h.prototype.GetAttributeInt32ForAllPoints = h.prototype.GetAttributeInt32ForAllPoints = function ( a, c, d ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! $b( b, a, c, d );

	}; h.prototype.GetAttributeUInt32ForAllPoints = h.prototype.GetAttributeUInt32ForAllPoints =
function ( a, c, d ) {

	var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); c && "object" === typeof c && ( c = c.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! ec( b, a, c, d );

}; h.prototype.SkipAttributeTransform = h.prototype.SkipAttributeTransform = function ( a ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); lc( b, a );

	}; h.prototype.__destroy__ = h.prototype.__destroy__ = function () {

		mc( this.ptr );

	}; C.prototype = Object.create( p.prototype ); C.prototype.constructor = C; C.prototype.__class__ = C; C.__cache__ = {}; a.Mesh = C; C.prototype.num_faces =
C.prototype.num_faces = function () {
	...
	}; ca.prototype = Object.create( p.prototype ); ca.prototype.constructor = ca; ca.prototype.__class__ = ca; ca.__cache__ = {}; a.VoidPtr = ca; ca.prototype.__destroy__ = ca.prototype.__destroy__ = function () {

		od( this.ptr );

	}; O.prototype =
Object.create( p.prototype ); O.prototype.constructor = O; O.prototype.__class__ = O; O.__cache__ = {}; a.DracoInt32Array = O; O.prototype.GetValue = O.prototype.GetValue = function ( a ) {

		var b = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return tc( b, a );
	...
	}; S.prototype = Object.create( p.prototype ); S.prototype.constructor = S; S.prototype.__class__ = S; S.__cache__ = {}; a.Metadata = S; S.prototype.__destroy__ =
S.prototype.__destroy__ = function () {
	...
	} )(); if ( "function" === typeof a.onModuleParsed )a.onModuleParsed(); return d;
