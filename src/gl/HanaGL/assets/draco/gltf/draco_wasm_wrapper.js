var $jscomp = $jscomp || {}; $jscomp.scope = {}; $jscomp.ASSUME_ES5 = ! 1; $jscomp.ASSUME_NO_NATIVE_MAP = ! 1; $jscomp.ASSUME_NO_NATIVE_SET = ! 1; $jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function ( d, k, f ) {
...
$jscomp.polyfill = function ( d, k, f, u ) {
	...
	if ( k ) {
		...
		f = $jscomp.global; d = d.split( "." ); for ( u = 0; u < d.length - 1; u ++ ) {

			var h = d[ u ]; h in f || ( f[ h ] = {} ); f = f[ h ];

		}d = d[ d.length - 1 ]; u = f[ d ]; k = k( u ); k != u && null != k && $jscomp.defineProperty( f, d, { configurable: ! 0, writable: ! 0, value: k } );
	...
	return d ? d : function ( d, f ) {
		...
		d = Number( d ); f = Number( f ); var k = d & 65535, h = f & 65535; return k * h + ( ( d >>> 16 & 65535 ) * h + k * ( f >>> 16 & 65535 ) << 16 >>> 0 ) | 0;
...
$jscomp.polyfill( "Math.clz32", function ( d ) {
	...
	return d ? d : function ( d ) {
		...
		d = Number( d ) >>> 0; if ( 0 === d ) return 32; var f = 0; 0 === ( d & 4294901760 ) && ( d <<= 16, f += 16 ); 0 === ( d & 4278190080 ) && ( d <<= 8, f += 8 ); 0 === ( d & 4026531840 ) && ( d <<= 4, f += 4 ); 0 === ( d & 3221225472 ) && ( d <<= 2, f += 2 ); 0 === ( d & 2147483648 ) && f ++; return f;
...
$jscomp.initSymbolIterator = function () {
	...
	var k = 0; return $jscomp.iteratorPrototype( function () {
...
$jscomp.iteratorPrototype = function ( d ) {
	...
	$jscomp.initSymbolIterator(); var k = d[ Symbol.iterator ]; return k ? k.call( d ) : $jscomp.arrayIterator( d );
...
$jscomp.polyfill( "Promise", function ( d ) {
	...
	function k() {
	...
	} if ( d && ! $jscomp.FORCE_POLYFILL_PROMISE ) return d; k.prototype.asyncExecute = function ( d ) {
	...
	}; var u = $jscomp.global.setTimeout; k.prototype.asyncExecuteFunction = function ( d ) {
		...
		for ( ;this.batch_ && this.batch_.length; ) {
			...
			var d = this.batch_; this.batch_ = []; for ( var B = 0; B < d.length; ++ B ) {

				var f = d[ B ]; delete d[ B ]; try {
		...
		this.state_ = 0; this.result_ = void 0; this.onSettledCallbacks_ = []; var r = this.createResolveAndReject_(); try {
...
function () {
	...
	} var f = this, h = ! 1; return { resolve: d( this.resolveTo_ ), reject: d( this.reject_ ) };
...
this.onSettledCallbacks_, f = 0; f < d.length; ++ f )d[ f ].call(), d[ f ] = null; this.onSettledCallbacks_ = null;
		...
		} ); this.callWhenSettled_( k( d, v ), k( f, r ) ); return B;
		...
		function h() {
			...
			switch ( k.state_ ) {
				...
				case 1:d( k.result_ ); break; case 2:f( k.result_ ); break; default:throw Error( "Unexpected state: " + k.state_ );

			}

		} var k = this; null == this.onSettledCallbacks_ ? ha.asyncExecute( h ) : this.onSettledCallbacks_.push( function () {

			ha.asyncExecute( h );

		} );

	}; h.resolve = f; h.reject = function ( d ) {
		...
		var k = $jscomp.makeIterator( d ), r = k.next(); return r.done ? f( [] ) : new h( function ( d, h ) {
			...
			} var u = [], B = 0; do u.push( void 0 ), B ++, f( r.value ).callWhenSettled_( v( u.length - 1 ), h ), r = k.next(); while ( ! r.done );
...
var DracoDecoderModule = function ( d ) {
	...
	function k( a, c ) {
		...
		if ( 0 === c || ! a ) return ""; for ( var b = 0, e, d = 0; ; ) {

			e = W[ a + d >> 0 ]; b |= e; if ( 0 == e && ! c ) break; d ++; if ( c && d == c ) break;

		}c || ( c = d ); e = ""; if ( 128 > b ) {

			for ( ;0 < c; )b = String.fromCharCode.apply( String, W.subarray( a, a + Math.min( c, 1024 ) ) ), e = e ? e + b : b, a += 1024, c -= 1024; return e;

		} return h( W, a );

	} function h( a, c ) {

		for ( var b = c; a[ b ]; )++ b; if ( 16 < b - c && a.subarray && Ia ) return Ia.decode( a.subarray( c, b ) ); for ( b =
""; ; ) {

			var e = a[ c ++ ]; if ( ! e ) return b; if ( e & 128 ) {

				var d = a[ c ++ ] & 63; if ( 192 == ( e & 224 ) )b += String.fromCharCode( ( e & 31 ) << 6 | d ); else {

					var f = a[ c ++ ] & 63; if ( 224 == ( e & 240 ) )e = ( e & 15 ) << 12 | d << 6 | f; else {

						var g = a[ c ++ ] & 63; if ( 240 == ( e & 248 ) )e = ( e & 7 ) << 18 | d << 12 | f << 6 | g; else {

							var h = a[ c ++ ] & 63; if ( 248 == ( e & 252 ) )e = ( e & 3 ) << 24 | d << 18 | f << 12 | g << 6 | h; else {

								var k = a[ c ++ ] & 63; e = ( e & 1 ) << 30 | d << 24 | f << 18 | g << 12 | h << 6 | k;
		...
		0 <
a % c && ( a += c - a % c ); return a;

	} function r() {

		a.HEAP8 = ia = new Int8Array( D ); a.HEAP16 = Ja = new Int16Array( D ); a.HEAP32 = E = new Int32Array( D ); a.HEAPU8 = W = new Uint8Array( D ); a.HEAPU16 = new Uint16Array( D ); a.HEAPU32 = new Uint32Array( D ); a.HEAPF32 = new Float32Array( D ); a.HEAPF64 = new Float64Array( D );

	} function B( e ) {

		for ( ;0 < e.length; ) {

			var c = e.shift(); if ( "function" == typeof c )c(); else {
		...
		var e = y.last; if ( ! e ) return ( sa( 0 ), 0 ) | 0; var c = y.infos[ e ], b = c.type; if ( ! b ) return ( sa( 0 ), e ) | 0; var p = Array.prototype.slice.call( arguments ); a.___cxa_is_pointer_type( b ); la.buffer || ( la.buffer = Ka( 4 ) ); E[ la.buffer >> 2 ] = e; e = la.buffer; for ( var d = 0; d < p.length; d ++ ) if ( p[ d ] && a.___cxa_can_catch( p[ d ], b, e ) ) return e = E[ e >> 2 ], c.adjusted = e, ( sa( p[ d ] ), e ) | 0; e = E[ e >> 2 ];
		return ( sa( b ), e ) | 0;
		...
		w.varargs = c; try {
			...
			var b = w.get(), p = w.get(), d = w.get(); e = 0; Z.buffers || ( Z.buffers = [ null, [], []], Z.printChar = function ( c, b ) {

				var e = Z.buffers[ c ]; f( e ); 0 === b || 10 === b ? ( ( 1 === c ? a.print : a.printErr )( h( e, 0 ) ), e.length = 0 ) : e.push( b );

			} ); for ( c = 0; c < d; c ++ ) {

				for ( var g = E[ p + 8 * c >> 2 ], k = E[ p + ( 8 * c + 4 ) >> 2 ], l = 0; l < k; l ++ )Z.printChar( b, W[ g + l ] ); e += k;
		...
		function c() {
			...
			if ( ! a.calledRun && ( a.calledRun = ! 0, ! oa ) ) {
				...
				La || ( La = ! 0, B( Ma ) ); B( Na ); if ( a.onRuntimeInitialized )a.onRuntimeInitialized(); if ( a.postRun ) for ( "function" == typeof a.postRun && ( a.postRun = [ a.postRun ] ); a.postRun.length; )Oa.unshift( a.postRun.shift() ); B( Oa );
			...
			B( Pa ); 0 < ea || a.calledRun || ( a.setStatus ? ( a.setStatus( "Running..." ), setTimeout( function () {
		...
		if ( a.onAbort )a.onAbort( e ); void 0 !== e ? ( a.print( e ), a.printErr( e ), e = JSON.stringify( e ) ) : e = ""; oa = ! 0; throw "abort(" + e + "). Build with -s ASSERTIONS=1 for more info.";

	} function m() {} function t( a ) {

		return ( a || m ).__cache__;

	} function T( a, c ) {

		var b = t( c ), e = b[ a ]; if ( e ) return e; e = Object.create( ( c || m ).prototype ); e.ptr = a; return b[ a ] = e;
...
0, b = 0; b < a.length; ++ b ) {
				...
				var e = a.charCodeAt( b ); 55296 <= e && 57343 >= e && ( e = 65536 + ( ( e & 1023 ) << 10 ) | a.charCodeAt( ++ b ) & 1023 ); 127 >= e ? ++ c : c = 2047 >= e ? c + 2 : 65535 >= e ? c + 3 : 2097151 >= e ? c + 4 : 67108863 >= e ? c + 5 : c + 6;

			}c = Array( c + 1 ); b = 0; e = c.length; if ( 0 < e ) {

				e = b + e - 1; for ( var d = 0; d < a.length; ++ d ) {

					var f = a.charCodeAt( d ); 55296 <= f && 57343 >= f && ( f = 65536 + ( ( f & 1023 ) << 10 ) | a.charCodeAt( ++ d ) & 1023 ); if ( 127 >= f ) {
						...
						if ( 2047 >= f ) {
							...
							if ( b + 1 >= e ) break; c[ b ++ ] = 192 | f >> 6;

						} else {

							if ( 65535 >= f ) {

								if ( b + 2 >= e ) break; c[ b ++ ] = 224 | f >> 12;
...
3 >= e ) break; c[ b ++ ] = 240 | f >> 18;
									...
									if ( 67108863 >= f ) {
										...
										if ( b + 4 >= e ) break; c[ b ++ ] = 248 | f >> 24;

									} else {

										if ( b + 5 >= e ) break; c[ b ++ ] = 252 | f >> 30; c[ b ++ ] = 128 | f >> 24 & 63;
		...
		this.ptr = Wa(); t( F )[ this.ptr ] = this;

	} function G() {

		this.ptr = Xa(); t( G )[ this.ptr ] = this;

	} function H() {

		this.ptr = Ya(); t( H )[ this.ptr ] = this;
		...
		this.ptr = $a(); t( J )[ this.ptr ] = this;

	} function n() {

		this.ptr = ab(); t( n )[ this.ptr ] = this;

	} function P() {

		this.ptr = bb(); t( P )[ this.ptr ] = this;

	} function x() {

		this.ptr = cb(); t( x )[ this.ptr ] = this;

	} function K() {

		this.ptr = db(); t( K )[ this.ptr ] = this;

	} function q() {

		this.ptr = eb(); t( q )[ this.ptr ] = this;

	} function L() {

		this.ptr = fb(); t( L )[ this.ptr ] = this;

	} function M() {

		this.ptr = gb(); t( M )[ this.ptr ] = this;

	} function V() {

		this.ptr = hb(); t( V )[ this.ptr ] = this;

	} function Q() {

		this.ptr = ib(); t( Q )[ this.ptr ] = this;
...
jb(); t( g )[ this.ptr ] = this;
		...
		this.ptr = lb(); t( N )[ this.ptr ] = this;

	} function R() {

		this.ptr = mb(); t( R )[ this.ptr ] = this;

	}d = d || {}; var a = "undefined" !== typeof d ? d : {}, Qa = ! 1, Ra = ! 1; a.onRuntimeInitialized = function () {

		Qa = ! 0; if ( Ra && "function" === typeof a.onModuleLoaded )a.onModuleLoaded( a );

	}; a.onModuleParsed = function () {

		Ra = ! 0; if ( Qa && "function" === typeof a.onModuleLoaded )a.onModuleLoaded( a );
...
}; var pa = {}, aa; for ( aa in a )a.hasOwnProperty( aa ) && ( pa[ aa ] = a[ aa ] ); a.arguments = []; a.thisProgram = "./this.program"; a.quit = function ( a, c ) {

		throw c;

	}; a.preRun = []; a.postRun = []; var ja = ! 1, fa = ! 1, qa = ! 1, za = ! 1; if ( a.ENVIRONMENT ) if ( "WEB" === a.ENVIRONMENT )ja = ! 0; else if ( "WORKER" === a.ENVIRONMENT )fa = ! 0; else if ( "NODE" === a.ENVIRONMENT )qa = ! 0; else if ( "SHELL" === a.ENVIRONMENT )za = ! 0; else throw Error( "Module['ENVIRONMENT'] value is not valid. must be one of: WEB|WORKER|NODE|SHELL." );
	else ja = "object" === typeof window, fa = "function" === typeof importScripts, qa = "object" === typeof process && "function" === typeof require && ! ja && ! fa, za = ! ja && ! qa && ! fa; if ( qa ) {

		var Aa, Ba; a.read = function ( a, c ) {

			Aa || ( Aa = require( "fs" ) ); Ba || ( Ba = require( "path" ) ); a = Ba.normalize( a ); a = Aa.readFileSync( a ); return c ? a : a.toString();

		}; a.readBinary = function ( e ) {

			e = a.read( e, ! 0 ); e.buffer || ( e = new Uint8Array( e ) ); f( e.buffer ); return e;

		}; 1 < process.argv.length && ( a.thisProgram = process.argv[ 1 ].replace( /\\/g, "/" ) ); a.arguments = process.argv.slice( 2 );
...
new TextDecoder( "utf-16le" ); var ia, W, Ja, E, ba, Ca, ta, ua, Da, ka; var Ea = ba = Ca = ta = ua = Da = ka = 0; var Sa = ! 1; a.reallocBuffer || ( a.reallocBuffer = function ( a ) {

		try {

			if ( ArrayBuffer.transfer ) var c = ArrayBuffer.transfer( D, a ); else {

				var b = ia; c = new ArrayBuffer( a ); ( new Int8Array( c ) ).set( b );
		...
		var Ta = Function.prototype.call.bind( Object.getOwnPropertyDescriptor( ArrayBuffer.prototype, "byteLength" ).get ); Ta( new ArrayBuffer( 4 ) );
...
5242880, A = a.TOTAL_MEMORY || 16777216; A < Fa && a.printErr( "TOTAL_MEMORY should be larger than TOTAL_STACK, was " + A + "! (TOTAL_STACK=" + Fa + ")" ); if ( a.buffer ) var D = a.buffer; else "object" === typeof WebAssembly && "function" === typeof WebAssembly.Memory ? ( a.wasmMemory = new WebAssembly.Memory( { initial: A / 65536 } ), D = a.wasmMemory.buffer ) : D = new ArrayBuffer( A ), a.buffer = D; r(); E[ 0 ] = 1668509029; Ja[ 1 ] = 25459; if ( 115 !== W[ 2 ] || 99 !== W[ 3 ] ) throw "Runtime error: expected the system to be little-endian!"; var Pa = [], Ma = [], Na = [], ob = [], Oa = [],
		La = ! 1, ea = 0, Ga = null, ra = null; a.preloadedImages = {}; a.preloadedAudios = {}; ( function () {

		function e() {

			try {

				if ( a.wasmBinary ) return new Uint8Array( a.wasmBinary ); if ( a.readBinary ) return a.readBinary( f ); throw "on the web, we need the wasm binary to be preloaded and set on Module['wasmBinary']. emcc.py will do that for you when generating HTML (but not JS)";
...
f + "'"; return a.arrayBuffer();
			...
			function g( a ) {
				...
				c().then( function ( a ) {
					...
					a.printErr( "failed to asynchronously prepare wasm: " + c ); O( c );

				} );

			} if ( "object" !== typeof WebAssembly ) return a.printErr( "no native wasm support detected" ), ! 1; if ( ! ( a.wasmMemory instanceof WebAssembly.Memory ) ) return a.printErr( "no native wasm Memory in use" ), ! 1; e.memory = a.wasmMemory; h.global = { NaN: NaN, Infinity: Infinity }; h[ "global.Math" ] = Math; h.env = e; ea ++; a.monitorRunDependencies &&
a.monitorRunDependencies( ea ); if ( a.instantiateWasm ) try {
				...
				a.printErr( "wasm streaming compile failed: " + c ); a.printErr( "falling back to ArrayBuffer instantiation" ); S( g );

			} ); return {};

		} var d =
"draco_decoder.wast", f = "draco_decoder.wasm", g = "draco_decoder.temp.asm.js"; "function" === typeof a.locateFile && ( Y( d ) || ( d = a.locateFile( d ) ), Y( f ) || ( f = a.locateFile( f ) ), Y( g ) || ( g = a.locateFile( g ) ) ); var h = { global: null, env: null, asm2wasm: { "f64-rem": function ( a, c ) {
			...
			} }, parent: a }, k = null; a.asmPreload = a.asm; var l = a.reallocBuffer; a.reallocBuffer = function ( c ) {

			if ( "asmjs" === m ) var b = l( c ); else a: {

				c = ha( c, a.usingWasm ? 65536 : 16777216 ); var e = a.buffer.byteLength; if ( a.usingWasm ) try {

					b = - 1 !==
a.wasmMemory.grow( ( c - e ) / 65536 ) ? a.buffer = a.wasmMemory.buffer : null; break a;
			...
			if ( ! e.table ) {
				...
				var p = a.wasmTableSize; void 0 === p && ( p = 1024 ); var f = a.wasmMaxTableSize; e.table = "object" === typeof WebAssembly && "function" === typeof WebAssembly.Table ? void 0 !== f ? new WebAssembly.Table( { initial: p, maximum: f, element: "anyfunc" } ) : new WebAssembly.Table( { initial: p, element: "anyfunc" } ) : Array( p ); a.wasmTable = e.table;
	...
	} )(); Ea = 1024; ba = Ea + 14480; Ma.push(); a.STATIC_BASE = Ea; a.STATIC_BUMP = 14480; var qb = ba; ba += 16; var y = { last: 0, caught: [], infos: {}, deAdjust: function ( a ) {

			if ( ! a || y.infos[ a ] ) return a; for ( var c in y.infos ) if ( y.infos[ c ].adjusted === a ) return c; return a;
		...
		decRef: function ( e ) {
			...
			if ( e ) {
				...
				var c = y.infos[ e ]; f( 0 < c.refcount ); c.refcount --; 0 !== c.refcount || c.rethrown || ( c.destructor && a.dynCall_vi( c.destructor, e ), delete y.infos[ e ], ___cxa_free_exception( e ) );
		...
		} }, w = { varargs: 0, get: function ( a ) {

			w.varargs += 4; return E[ w.varargs - 4 >> 2 ];
			...
			var a = w.get(), c = w.get(); 0 <= a ? f( 0 === c ) : f( - 1 === c ); return a;

		}, getZero: function () {

			f( 0 === w.get() );

		} }, va = {}, Ha = 1; ka = function ( a ) {

		f( ! Sa ); var c = ba; ba = ba +
a + 15 & - 16; return c;

	}( 4 ); Ca = ta = k( ba ); ua = Ca + Fa; Da = k( ua ); E[ ka >> 2 ] = Da; Sa = ! 0; a.wasmTableSize = 468; a.wasmMaxTableSize = 468; a.asmGlobalArg = {}; a.asmLibraryArg = { abort: O, assert: f, enlargeMemory: function () {

		var e = a.usingWasm ? 65536 : 16777216, c = 2147483648 - e; if ( E[ ka >> 2 ] > c ) return ! 1; var b = A; for ( A = Math.max( A, 16777216 ); A < E[ ka >> 2 ]; )A = 536870912 >= A ? ha( 2 * A, e ) : Math.min( ha( ( 3 * A + 2147483648 ) / 4, e ), c ); e = a.reallocBuffer( A ); if ( ! e || e.byteLength != A ) return A = b, ! 1; a.buffer = D = e; r(); return ! 0;
...
A + ", (2) compile with  -s ALLOW_MEMORY_GROWTH=1  which allows increasing the size at runtime, or (3) if you want malloc to return NULL (0) instead of this abort, compile with  -s ABORTING_MALLOC=0 " );
		...
		try {
			...
			if ( "number" !== typeof p && "longjmp" !== p ) throw p; a.setThrew( 1, 0 );
		...
		try {
			...
			if ( "number" !== typeof S && "longjmp" !== S ) throw S; a.setThrew( 1, 0 );
		...
		try {
			...
			if ( "number" !== typeof da && "longjmp" !== da ) throw da; a.setThrew( 1, 0 );
		...
		try {
			...
			if ( "number" !== typeof xa && "longjmp" !== xa ) throw xa; a.setThrew( 1, 0 );
		...
		try {
			...
			if ( "number" !== typeof ca && "longjmp" !== ca ) throw ca; a.setThrew( 1, 0 );
		...
		var c = y.infos[ a ]; c && ! c.caught && ( c.caught = ! 0, v.uncaught_exception -- ); c && ( c.rethrown = ! 1 ); y.caught.push( a ); y.addRef( y.deAdjust( a ) ); return a;

	}, ___cxa_find_matching_catch: la, ___cxa_pure_virtual: function () {

		oa = ! 0; throw "Pure virtual function called!";

	}, ___cxa_throw: function ( a,
		c, b ) {

		y.infos[ a ] = { ptr: a, adjusted: a, type: c, destructor: b, refcount: 0, caught: ! 1, rethrown: ! 1 }; y.last = a; "uncaught_exception" in v ? v.uncaught_exception ++ : v.uncaught_exception = 1; throw a + " - Exception catching is disabled, this exception cannot be caught. Compile with -s DISABLE_EXCEPTION_CATCHING=0 or DISABLE_EXCEPTION_CATCHING=2 to catch.";
		...
		a.___errno_location && ( E[ a.___errno_location() >> 2 ] = d ); return d;

	}, ___syscall140: function ( a, c ) {

		w.varargs = c; try {

			var b = w.getStreamFromFD(); w.get(); var d = w.get(), e = w.get(), f = w.get(); FS.llseek( b, d, f ); E[ e >> 2 ] = b.position; b.getdents && 0 === d && 0 === f && ( b.getdents = null ); return 0;
		...
		w.varargs = c; try {
			...
			var b = w.getStreamFromFD(); FS.close( b ); return 0;
...
typeof FS && p instanceof FS.ErrnoError || O( p ), - p.errno;
		...
		W.set( W.subarray( c, c + b ), a ); return a;
		...
		if ( 0 == a ) return 22; E[ a >> 2 ] = Ha; va[ Ha ] = 0; Ha ++; return 0;

	}, _pthread_once: ma, _pthread_setspecific: function ( a, c ) {

		if ( ! ( a in va ) ) return 22; va[ a ] = c; return 0;
...
Z.buffers; c[ 1 ].length && d( 1, 10 ); c[ 2 ].length && d( 2, 10 );
	...
	}, DYNAMICTOP_PTR: ka, tempDoublePtr: qb, ABORT: oa, STACKTOP: ta, STACK_MAX: ua }; var Ua = a.asm( a.asmGlobalArg, a.asmLibraryArg, D ); a.asm = Ua; a.___cxa_can_catch = function () {
...
function () {
	...
	}; na.prototype = Error(); na.prototype.constructor = na; ra = function c() {

		a.calledRun || wa(); a.calledRun || ( ra = c );

	}; a.run = wa; a.exit = function ( c, b ) {

		if ( ! b || ! a.noExitRuntime || 0 !== c ) {

			if ( ! a.noExitRuntime && ( oa = ! 0, ta = void 0, B( ob ), a.onExit ) )a.onExit( c ); qa && process.exit( c ); a.quit( c, new na( c ) );

		}

	}; a.abort = O; if ( a.preInit ) for ( "function" == typeof a.preInit && ( a.preInit = [ a.preInit ] ); 0 < a.preInit.length; )a.preInit.pop()(); a.noExitRuntime = ! 0;
	wa(); m.prototype = Object.create( m.prototype ); m.prototype.constructor = m; m.prototype.__class__ = m; m.__cache__ = {}; a.WrapperObject = m; a.getCache = t; a.wrapPointer = T; a.castObject = function ( a, b ) {

		return T( a.ptr, b );

	}; a.NULL = T( 0 ); a.destroy = function ( a ) {

		if ( ! a.__destroy__ ) throw "Error: Cannot destroy object. (Did you create it yourself?)"; a.__destroy__(); delete t( a.__class__ )[ a.ptr ];
...
{ buffer: 0, size: 0, pos: 0, temps: [], needed: 0, prepare: function () {
	...
	if ( l.needed ) {
		...
		for ( var c = 0; c < l.temps.length; c ++ )a._free( l.temps[ c ] ); l.temps.length = 0; a._free( l.buffer ); l.buffer = 0; l.size += l.needed; l.needed = 0;

	}l.buffer || ( l.size += 128, l.buffer = a._malloc( l.size ), f( l.buffer ) ); l.pos = 0;

}, alloc: function ( c, b ) {

	f( l.buffer ); c = c.length * b.BYTES_PER_ELEMENT; c = c + 7 & - 8; l.pos + c >= l.size ? ( f( 0 < c ), l.needed += c, b = a._malloc( c ), l.temps.push( b ) ) : ( b = l.buffer + l.pos, l.pos += c ); return b;
...
1; break; case 4:d >>= 2; break; case 8:d >>= 3;
...
} }; z.prototype = Object.create( m.prototype ); z.prototype.constructor = z; z.prototype.__class__ = z; z.__cache__ = {}; a.Status = z; z.prototype.code = z.prototype.code = function () {
	...
	F.prototype.constructor = F; F.prototype.__class__ = F; F.__cache__ = {}; a.DracoUInt16Array = F; F.prototype.GetValue = F.prototype.GetValue = function ( a ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return lc( c, a );
	...
	}; G.prototype = Object.create( m.prototype ); G.prototype.constructor = G; G.prototype.__class__ = G; G.__cache__ = {}; a.PointCloud = G; G.prototype.num_attributes = G.prototype.num_attributes =
function () {
	...
	}; H.prototype = Object.create( m.prototype ); H.prototype.constructor = H; H.prototype.__class__ = H; H.__cache__ = {}; a.DracoUInt8Array = H; H.prototype.GetValue = H.prototype.GetValue = function ( a ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return rc( c, a );
...
H.prototype.__destroy__ = function () {
...
}; I.prototype = Object.create( m.prototype ); I.prototype.constructor = I; I.prototype.__class__ = I; I.__cache__ = {}; a.DracoUInt32Array = I; I.prototype.GetValue = I.prototype.GetValue = function ( a ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return oc( c, a );
	...
	}; J.prototype = Object.create( m.prototype ); J.prototype.constructor = J; J.prototype.__class__ =
J; J.__cache__ = {}; a.AttributeOctahedronTransform = J; J.prototype.InitFromAttribute = J.prototype.InitFromAttribute = function ( a ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return !! rb( c, a );
	...
	}; n.prototype = Object.create( m.prototype ); n.prototype.constructor = n; n.prototype.__class__ = n; n.__cache__ = {}; a.PointAttribute = n; n.prototype.size = n.prototype.size =
function () {
...
function () {
	...
	}; P.prototype = Object.create( m.prototype ); P.prototype.constructor = P; P.prototype.__class__ = P; P.__cache__ = {}; a.AttributeTransformData = P; P.prototype.transform_type = P.prototype.transform_type = function () {
...
P.prototype.__destroy__ = function () {
	...
	zb( this.ptr );
...
}; x.prototype = Object.create( m.prototype ); x.prototype.constructor = x; x.prototype.__class__ = x; x.__cache__ = {}; a.AttributeQuantizationTransform = x; x.prototype.InitFromAttribute = x.prototype.InitFromAttribute = function ( a ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return !! ub( c, a );
		...
		var c = this.ptr; a && "object" ===
typeof a && ( a = a.ptr ); return wb( c, a );
	...
	}; K.prototype = Object.create( m.prototype ); K.prototype.constructor = K; K.prototype.__class__ = K; K.__cache__ = {}; a.DracoInt8Array = K; K.prototype.GetValue = K.prototype.GetValue = function ( a ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return ic( c, a );
...
}; q.prototype = Object.create( m.prototype ); q.prototype.constructor = q; q.prototype.__class__ = q; q.__cache__ = {}; a.MetadataQuerier = q; q.prototype.HasEntry = q.prototype.HasEntry = function ( a, b ) {

		var c = this.ptr; l.prepare(); a && "object" === typeof a && ( a = a.ptr ); b = b && "object" === typeof b ? b.ptr : U( b ); return !! Ec( c, a, b );

	}; q.prototype.HasIntEntry = q.prototype.HasIntEntry = function ( a, b ) {

		var c = this.ptr; l.prepare(); a && "object" === typeof a && ( a = a.ptr ); b = b && "object" === typeof b ? b.ptr : U( b );
		return !! Fc( c, a, b );

	}; q.prototype.GetIntEntry = q.prototype.GetIntEntry = function ( a, b ) {

		var c = this.ptr; l.prepare(); a && "object" === typeof a && ( a = a.ptr ); b = b && "object" === typeof b ? b.ptr : U( b ); return Bc( c, a, b );

	}; q.prototype.HasDoubleEntry = q.prototype.HasDoubleEntry = function ( a, b ) {

		var c = this.ptr; l.prepare(); a && "object" === typeof a && ( a = a.ptr ); b = b && "object" === typeof b ? b.ptr : U( b ); return !! Dc( c, a, b );

	}; q.prototype.GetDoubleEntry = q.prototype.GetDoubleEntry = function ( a, b ) {

		var c = this.ptr; l.prepare(); a && "object" === typeof a && ( a =
a.ptr ); b = b && "object" === typeof b ? b.ptr : U( b ); return zc( c, a, b );

	}; q.prototype.HasStringEntry = q.prototype.HasStringEntry = function ( a, b ) {

		var c = this.ptr; l.prepare(); a && "object" === typeof a && ( a = a.ptr ); b = b && "object" === typeof b ? b.ptr : U( b ); return !! Gc( c, a, b );

	}; q.prototype.GetStringEntry = q.prototype.GetStringEntry = function ( a, b ) {

		var c = this.ptr; l.prepare(); a && "object" === typeof a && ( a = a.ptr ); b = b && "object" === typeof b ? b.ptr : U( b ); return u( Cc( c, a, b ) );

	}; q.prototype.NumEntries = q.prototype.NumEntries = function ( a ) {

		var c = this.ptr;
		a && "object" === typeof a && ( a = a.ptr ); return Hc( c, a );

	}; q.prototype.GetEntryName = q.prototype.GetEntryName = function ( a, b ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); b && "object" === typeof b && ( b = b.ptr ); return u( Ac( c, a, b ) );

	}; q.prototype.__destroy__ = q.prototype.__destroy__ = function () {

		Ic( this.ptr );

	}; L.prototype = Object.create( m.prototype ); L.prototype.constructor = L; L.prototype.__class__ = L; L.__cache__ = {}; a.DracoInt16Array = L; L.prototype.GetValue = L.prototype.GetValue = function ( a ) {
...
( a = a.ptr ); return cc( c, a );
	...
	}; M.prototype = Object.create( m.prototype ); M.prototype.constructor = M; M.prototype.__class__ = M; M.__cache__ = {}; a.DracoFloat32Array = M; M.prototype.GetValue = M.prototype.GetValue = function ( a ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return $b( c, a );
...
}; V.prototype = Object.create( m.prototype ); V.prototype.constructor = V; V.prototype.__class__ = V; V.__cache__ = {}; a.GeometryAttribute = V; V.prototype.__destroy__ = V.prototype.__destroy__ = function () {

		uc( this.ptr );

	}; Q.prototype = Object.create( m.prototype ); Q.prototype.constructor = Q; Q.prototype.__class__ = Q; Q.__cache__ = {}; a.DecoderBuffer = Q; Q.prototype.Init = Q.prototype.Init = function ( a, b ) {

		var c = this.ptr; l.prepare(); if ( "object" == typeof a && "object" === typeof a ) {

			var d = l.alloc( a, ia ); l.copy( a, ia, d ); a =
d;

		}b && "object" === typeof b && ( b = b.ptr ); Bb( c, a, b );

	}; Q.prototype.__destroy__ = Q.prototype.__destroy__ = function () {

		Cb( this.ptr );

	}; g.prototype = Object.create( m.prototype ); g.prototype.constructor = g; g.prototype.__class__ = g; g.__cache__ = {}; a.Decoder = g; g.prototype.GetEncodedGeometryType = g.prototype.GetEncodedGeometryType = function ( a ) {
		...
		var c = this.ptr; a && "object" === typeof a &&
( a = a.ptr ); b && "object" === typeof b && ( b = b.ptr ); return T( Eb( c, a, b ), z );

	}; g.prototype.DecodeBufferToMesh = g.prototype.DecodeBufferToMesh = function ( a, b ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); b && "object" === typeof b && ( b = b.ptr ); return T( Db( c, a, b ), z );

	}; g.prototype.GetAttributeId = g.prototype.GetAttributeId = function ( a, b ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); b && "object" === typeof b && ( b = b.ptr ); return Kb( c, a, b );

	}; g.prototype.GetAttributeIdByName = g.prototype.GetAttributeIdByName = function ( a, b ) {

		var c =
this.ptr; l.prepare(); a && "object" === typeof a && ( a = a.ptr ); b = b && "object" === typeof b ? b.ptr : U( b ); return Jb( c, a, b );

	}; g.prototype.GetAttributeIdByMetadataEntry = g.prototype.GetAttributeIdByMetadataEntry = function ( a, b, d ) {

		var c = this.ptr; l.prepare(); a && "object" === typeof a && ( a = a.ptr ); b = b && "object" === typeof b ? b.ptr : U( b ); d = d && "object" === typeof d ? d.ptr : U( d ); return Ib( c, a, b, d );

	}; g.prototype.GetAttribute = g.prototype.GetAttribute = function ( a, b ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); b && "object" === typeof b && ( b =
b.ptr ); return T( Tb( c, a, b ), n );

	}; g.prototype.GetAttributeByUniqueId = g.prototype.GetAttributeByUniqueId = function ( a, b ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); b && "object" === typeof b && ( b = b.ptr ); return T( Fb( c, a, b ), n );

	}; g.prototype.GetMetadata = g.prototype.GetMetadata = function ( a ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); return T( Wb( c, a ), R );
...
( b = b.ptr ); return T( Pb( c, a, b ), R );
		...
		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); b && "object" === typeof b && ( b = b.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! Vb( c, a, b, d );

	}; g.prototype.GetTriangleStripsFromMesh = g.prototype.GetTriangleStripsFromMesh = function ( a, b ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); b && "object" === typeof b && ( b = b.ptr ); return Xb( c, a, b );

	}; g.prototype.GetAttributeFloat = g.prototype.GetAttributeFloat = function ( a,
		b, d ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); b && "object" === typeof b && ( b = b.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! Hb( c, a, b, d );

	}; g.prototype.GetAttributeFloatForAllPoints = g.prototype.GetAttributeFloatForAllPoints = function ( a, b, d ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); b && "object" === typeof b && ( b = b.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! Gb( c, a, b, d );

	}; g.prototype.GetAttributeIntForAllPoints = g.prototype.GetAttributeIntForAllPoints = function ( a, b, d ) {

		var c = this.ptr; a && "object" ===
typeof a && ( a = a.ptr ); b && "object" === typeof b && ( b = b.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! Ob( c, a, b, d );

	}; g.prototype.GetAttributeInt8ForAllPoints = g.prototype.GetAttributeInt8ForAllPoints = function ( a, b, d ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); b && "object" === typeof b && ( b = b.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! Nb( c, a, b, d );
...
typeof b && ( b = b.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! Sb( c, a, b, d );

	}; g.prototype.GetAttributeInt16ForAllPoints = g.prototype.GetAttributeInt16ForAllPoints = function ( a, b, d ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); b && "object" === typeof b && ( b = b.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! Lb( c, a, b, d );

	}; g.prototype.GetAttributeUInt16ForAllPoints = g.prototype.GetAttributeUInt16ForAllPoints = function ( a, b, d ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); b && "object" === typeof b && ( b = b.ptr ); d &&
"object" === typeof d && ( d = d.ptr ); return !! Qb( c, a, b, d );

	}; g.prototype.GetAttributeInt32ForAllPoints = g.prototype.GetAttributeInt32ForAllPoints = function ( a, b, d ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); b && "object" === typeof b && ( b = b.ptr ); d && "object" === typeof d && ( d = d.ptr ); return !! Mb( c, a, b, d );

	}; g.prototype.GetAttributeUInt32ForAllPoints = g.prototype.GetAttributeUInt32ForAllPoints = function ( a, b, d ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); b && "object" === typeof b && ( b = b.ptr ); d && "object" === typeof d && ( d =
d.ptr ); return !! Rb( c, a, b, d );

	}; g.prototype.SkipAttributeTransform = g.prototype.SkipAttributeTransform = function ( a ) {

		var c = this.ptr; a && "object" === typeof a && ( a = a.ptr ); Yb( c, a );

	}; g.prototype.__destroy__ = g.prototype.__destroy__ = function () {

		Zb( this.ptr );

	}; C.prototype = Object.create( m.prototype ); C.prototype.constructor = C; C.prototype.__class__ = C; C.__cache__ = {}; a.Mesh = C; C.prototype.num_faces = C.prototype.num_faces = function () {
	...
	}; X.prototype = Object.create( m.prototype ); X.prototype.constructor = X; X.prototype.__class__ = X; X.__cache__ = {}; a.VoidPtr = X; X.prototype.__destroy__ = X.prototype.__destroy__ = function () {

		ad( this.ptr );

	}; N.prototype = Object.create( m.prototype ); N.prototype.constructor = N; N.prototype.__class__ = N; N.__cache__ = {}; a.DracoInt32Array = N; N.prototype.GetValue = N.prototype.GetValue =
function ( a ) {
	...
	}; R.prototype = Object.create( m.prototype ); R.prototype.constructor = R; R.prototype.__class__ = R; R.__cache__ = {}; a.Metadata = R; R.prototype.__destroy__ = R.prototype.__destroy__ = function () {
